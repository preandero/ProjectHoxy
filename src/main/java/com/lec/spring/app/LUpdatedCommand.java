...
public class LUpdatedCommand implements ACommand{
    ...
    public void execute(Model model) {
        ...
        int graphView6;
        int graphView7;
       if((String)map.get("graphView1") ==null){
           graphView1 = 0;
       }else{
           graphView1 = 1;
        }
        if((String)map.get("graphView2") ==null){
            graphView2 = 0;
        }else{
            graphView2 = 1;
        }
        if((String)map.get("graphView3") ==null){
            graphView3 = 0;
        }else{
            graphView3 = 1;
        }
        if((String)map.get("graphView4") ==null){
            graphView4 = 0;
        }else{
            graphView4 = 1;
        }
        if((String)map.get("graphView5") ==null){
            graphView5 = 0;
        }else{
            graphView5 = 1;
        }
        if((String)map.get("graphView6") ==null){
            graphView6 = 0;
        }else{
            graphView6 = 1;
        }
        if((String)map.get("graphView7") ==null){
            graphView7 = 0;
        }else{
            graphView7 = 1;
        }
