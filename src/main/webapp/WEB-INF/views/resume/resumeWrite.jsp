...
<%--                                <button type="button" id="btn-upload" >upload</button>--%>
        ...
        <div id="edu" class="container pr-5 pl-5 pb-5 pt-0 mt-0 border bg-white">
            ...
            <div class="form-group row">
                ...
                <input type="text" class="form-control w-25 my-2" id="eduElePeriod" placeholder="YYYY/MM">
                 <span class="d-flex justify-content-center my-2 ml-3"> <h2> ~ </h2> </span>
                <input type="text" class="form-control w-25 ml-4 my-2" id="eduElePeriod2" placeholder="YYYY/MM">
            </div>
            ...
            <div id="eduMed">
                ...
                <div class="form-group row">
                    <label class="ml-3 my-3 mr-2">재학기간<span class="req my-3">필수</span></label>
                    <input type="text" class="form-control w-25 my-2" id="eduMedPeriod" placeholder="YYYY/MM">
                    <span class="d-flex justify-content-center my-2 ml-3"> <h2> ~ </h2> </span>
                    <input type="text" class="form-control w-25 ml-4 my-2" id="eduMedPeriod2" placeholder="YYYY/MM">
                </div>
                <div class="form-group row my-2">
                    <label class="ml-3 my-3 mr-4 pr-2">지역</label>
                    <select class="browser-default custom-select w-25 ml-5 my-2">
                ...
                <div id="eduHigh">
                    ...
                    <div class="form-group row">
                        <label class="ml-3 my-3 mr-2">재학기간<span class="req my-3">필수</span></label>
                        <input type="text" class="form-control w-25 my-2" id="eduHighPeriod" placeholder="YYYY/MM">
                        <span class="d-flex justify-content-center my-2 ml-3"> <h2> ~ </h2> </span>
                        <input type="text" class="form-control w-25 ml-4 my-2" id="eduHighPeriod2" placeholder="YYYY/MM">
                    </div>
                    <div class="form-group row">
            ...
            <div id="eduUni">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="form-control w-25 ml-5" id="EduUniName">

                </div>
                <div class="form-group row">
                    <label class="ml-3 my-3 mr-4">재학기간<span class="req my-3">필수</span></label>
                    <input type="text" class="form-control w-25 my-2" id="eduUniPeriod" placeholder="YYYY/MM">
                    <span class="d-flex justify-content-center my-2 ml-3"> <h2> ~ </h2> </span>
                    <input type="text" class="form-control w-25 ml-4 my-2" id="eduUniPeriod2" placeholder="YYYY/MM">
                </div>
                <div class="form-group row">
                    <label class="ml-3 my-2 ">전공 계열</label><span class="req my-2">필수</span>
                    <input type="text" class="form-control w-25 ml-5" id="EduUniMajor">

                </div>
                <div class="form-group row">
                    <label class="ml-3 my-2 ">전공 학과</label><span class="req my-2">필수</span>
                    <input type="text" class="form-control w-25 ml-5" id="EduUniDep">
        ...
        <div id="career" class="container pr-5 pl-5 pb-5 pt-0 mt-0 border bg-white">
            ...
            <div id="careerform">
                <div class="form-group row mt-5">
                    ...
                    <input type="text" class="form-control w-25 ml-5" id="comName">
                </div>
                <div class="form-group row">
                    <label class="ml-3 my-3 mr-2">재직기간<span class="req my-3 mr-4">필수</span></label>
                    <input type="text" class="form-control w-25 my-2" id="comPeriod" placeholder="YYYY/MM">
                    <span class="d-flex justify-content-center my-2 ml-3"> <h2> ~ </h2> </span>
                    <input type="text" class="form-control w-25 ml-4 my-2" id="comPeriod2" placeholder="YYYY/MM">
                </div>
                <div class="form-group row">
                    <label class="ml-3 my-2 ">직급/직책</label><span class="req mt-2 mr-1">필수</span>
                    <input type="text" class="form-control w-25 ml-4" id="comPosition">

                </div>
                <div class="form-group row">
                    <label class="ml-3 my-2 ">직종</label><span class="req my-2 mr-3">필수</span>
                    <input type="text" class="form-control w-25 ml-5" id="comJobType">

                </div>
                <div class="form-group row">
                    <label class="ml-3 my-2 ">연봉</label><span class="req my-2 mr-3">필수</span>
                    <input type="text" class="form-control w-25 ml-5" id="comIncome">

                </div>
                <div class="form-group row w-25">
                    <label class="ml-3 my-2 ">총 경력</label><span class="req my-2">필수</span>
                    <input type="text" class="form-control w-25 ml-5" id="totalCareer">
        ...
        <div class="container p-5 border bg-white">
            <div class="form-group row">
                ...
                <input type="text" class="form-control w-25 ml-5" id="toeicScore">
        ...
        <div class="container p-5 border bg-light">
            ...
            <textarea class="form-control h-25 DOC_TEXT"></textarea>
        ...
        <div class="container p-5 border bg-white">
            <div class="form-group row my-4">
                ...
                <select class="browser-default custom-select w-25  my-2">
                    <option selected>선택</option>
                    <option value="1">서울</option>
                    <option value="2">경기</option>
                    <option value="3">인천</option>
            ...
            <div class="form-group row w-50 my-4">
                <label class="ml-3 my-2">연봉</label><span class="req my-2 mr-3">필수</span>
                <input type="text" class="form-control w-25 ml-5" id="hopeIncome"><span class="ml-3 my-2">만원</span>

            </div>
            <div class="form-group row my-4">
                <label class="ml-3 my-2">근무지역</label><span class="req my-2 mr-1">필수</span>
                <input type="text" class="form-control w-25 ml-4" id="hopeArea">

            </div>

            <div class="form-group row my-4">
                <label class="ml-3 my-2">직종</label><span class="req my-2 mr-2">필수</span>
                <input type="text" class="form-control w-25 ml-5" id="hopeJopType">
        ...
        <div class="container p-5 border bg-white">
            <div class="form-group row">
                ...
                <input type="text" class="form-control w-75 ml-5" id="portUrl">
